...
vim.keymap.set('n', '<leader>ng', ':Neogit<CR>', { noremap = true, silent = true, desc = 'Neogit Status' })

-- Zen mode
vim.keymap.set('n', '<leader>z', ':ZenMode<CR>', { noremap = true, silent = true, desc = 'Toggle Zen Mode' })

-- Rename without lsp
vim.keymap.set('n', '<leader>rr', ':%s/\\<<C-r><C-w>\\>//g<left><left>', { noremap = true, desc = 'Rename without LSP' })
-- Rename without lsp and case sensitive
vim.keymap.set('n', '<leader>rR', ':%s/\\<<C-r><C-w>\\>//g<left><left>', { noremap = true, desc = 'Rename without LSP and case sensitive' })
