...
vim.keymap.set('n', '<leader>sp', require('telescope.builtin').help_tags, { desc = '[S]earch Hel[P]' })
vim.keymap.set('n', '<leader>sw', require('telescope.builtin').grep_string, { desc = '[S]earch current [W]ord' })
vim.keymap.set('n', '<leader>sh', require('telescope.builtin').git_files, { desc = '[S]earch by [G]it files' })
...
-- LSP config
-- require('lspconfig').solargraph.setup()setup = {
--   solargraph = function()
